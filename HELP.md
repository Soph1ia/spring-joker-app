...
* The original package name 'spring.framework.joker.example.joker-example' is invalid and this project uses 'spring.framework.joker.example.jokerexample' instead.
